                ...
                <div className='rounded-[10px] bg-[white] login-modal h-[60%] w-[40%]'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='mt-8 text-center'>
                            <input onChange={(e)=>setEmail(e.target.value)} className='w-[55%] border-1 border-solid border-[#CFD9DE] rounded-[3px] pe-2 pt-3 pb-3 ps-2' placeholder='Enter Your Email ID'></input>
                        </div>

                        <div className='mt-8 text-center'>
                            <button className='h-[50px] w-[55%] bg-[black] text-white rounded-[25px] font-bold'>Sign In / Register</button>
                        </div>
                    </form>
